    ...
    function filterCards(searchTerm, filterValue) {
        document.querySelectorAll('.prompt-card').forEach(card => {
            ...
            if (filterValue && filterValue !== 'all') {
                if (filterValue === '★★★★★') {
                    filterMatch = card.getAttribute('data-usage') === '★★★★★';
                } else if (filterValue === 'ChatGPT' || filterValue === 'Google AI Studio' || filterValue === "Genspark" || filterValue === "ALL") {
                   filterMatch = card.getAttribute('data-model') === filterValue;
                }else {
                    filterMatch = card.getAttribute('data-category') === filterValue;
                }
            }
